...
//+------------------------------------------------------------------+
//| USDCAD Strategy 1: Volatility Breakout (4H)                      |
//+------------------------------------------------------------------+
class CUSDCAD_Strategy1_Breakout : public CStrategyBase
{
private:
    int m_atrPeriod;
    int m_rangePeriod;
...
public:
    CUSDCAD_Strategy1_Breakout(CLogger* logger, CRiskManager* riskManager) 
        : CStrategyBase("USDCAD_Strategy1_Breakout", logger, riskManager)
    {
        m_atrPeriod = 14;
        m_rangePeriod = 10;
        m_rangeMultiplier = 0.5;
        m_lastBarTime = 0;
    }
    ...
    virtual TradeSignal GenerateSignal() override
    {
        ...
        bool breakoutLong = closePrice > (maxHigh + m_rangeMultiplier * atr);
        bool breakoutShort = closePrice < (minLow - m_rangeMultiplier * atr);
        ...
        if(breakoutLong)
        {
             ...
             signal.reason = "USDCAD-1: Volatility Breakout (4H)";
             return signal;
        }
